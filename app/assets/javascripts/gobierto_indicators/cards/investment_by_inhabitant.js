...
var InvestmentByInhabitantCard = Class.extend({
  ...
  getData: function() {
    ...
    d3.queue()
      ...
      .await(function (error, json, bcn, vlc) {
        ...
        var bcn = this.data.filter(function(d) { return d.location_name === 'Barcelona'; });
        var vlc = this.data.filter(function(d) { return d.location_name === 'Valencia'; });
