...
module GobiertoAdmin
  module GobiertoCms
    class SectionItemsController < ::GobiertoAdmin::GobiertoCms::BaseController
      def create
      ...
      def index
        ...
        render(
          json: { section_items: @section.section_items.without_parent.sorted.map{ |si| default_serializer.new(si) }}
        )
      end
