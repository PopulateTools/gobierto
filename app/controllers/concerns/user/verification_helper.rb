module User::VerificationHelper
  ...
  def raise_user_not_verified
    redirect_to(
      ...
      alert: t("user.census_verifications.messages.#{controller_name}.not_verified", site_name: current_site.name, default: 'user.census_verifications.messages.not_verified')
    )
  end
end
