    ...
    module Configuration
      module Settings
        class UpdateSettingsTest < ActionDispatch::IntegrationTest
          ...
          def setup
            super
            @path = edit_admin_visualizations_configuration_settings_path
          end
          ...
          def invalid_config
            @invalid_config ||= { visualizations: {foo: :bar} }.to_json
          end
          ...
          def test_update_visualizations_config_invalid_json
            with(site: site, admin: admin) do
              visit @path

              fill_in "gobierto_visualizations_settings_visualizations_config", with: "wadus wadus"
          ...
          def test_update_visualizations_config_invalid_config
            with(site: site, admin: admin) do
              visit @path

              fill_in "gobierto_visualizations_settings_visualizations_config", with: invalid_config
          ...
          def test_update_visualizations_config_valid_config
            with(site: site, admin: admin) do
              visit @path

              assert has_field? "gobierto_visualizations_settings_visualizations_config", with: ''

              fill_in "gobierto_visualizations_settings_visualizations_config", with: valid_config
