...
export const contractsColumns = [
  { field: 'assignee', name: I18n.t('gobierto_visualizations.visualizations.contracts.assignee'), format: null, cssClass: '' },
  ...
  { field: 'batch_number', name: I18n.t('gobierto_visualizations.visualizations.contracts.batches'), format: null, cssClass: 'nowrap pl1', type: 'numeric' },
  ...
  { field: 'assignee_type', name: 'permalink', format: null, cssClass: 'nowrap pl1', type: 'string' },
  ...
  { field: 'initial_amount', name: I18n.t('gobierto_visualizations.visualizations.contracts.initial_amount'), format: null, cssClass: 'nowrap pl1', type: 'money' },
  { field: 'initial_amount_no_taxes', name: I18n.t('gobierto_visualizations.visualizations.contracts.initial_amount_no_taxes'), format: null, cssClass: 'nowrap pl1', type: 'money' },
  { field: 'final_amount', name: I18n.t('gobierto_visualizations.visualizations.contracts.final_amount'), format: null, cssClass: 'nowrap pl1', type: 'money' },
  ...
  { field: 'contractor_id', name: 'permalink', format: null, cssClass: 'nowrap pl1', type: 'numeric' },
  ...
  { field: 'cpvs', name: 'cpvs', format: null, cssClass: 'nowrap pl1', type: 'numeric' },
  { field: 'category_id', name: 'permalink', format: null, cssClass: 'nowrap pl1', type: 'numeric' },
  ...
  { field: 'number_of_proposals', name: I18n.t('gobierto_visualizations.visualizations.contracts.number_of_proposals'), format: null, cssClass: 'nowrap pl1', type: 'numeric' },
  { field: 'range', name: I18n.t('gobierto_visualizations.visualizations.contracts.range'), format: null, cssClass: 'nowrap pl1', type: 'numeric' },
  { field: 'award_date_year', name: I18n.t('gobierto_visualizations.visualizations.contracts.award_date_year'), format: null, cssClass: 'nowrap pl1', type: 'numeric' },
];
