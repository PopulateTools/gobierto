$(document).on('turbolinks:load', function() {
	...
	$('.show_login_box').click(function(e) {
		...
		$('.confirmation_request_box').addClass("hidden");
	...
	$('.show_confirmation_request_box').click(function(e) {
		e.preventDefault();
		$('.login_box').addClass("hidden");
		$('.password_recovery_box').addClass("hidden");
		$('.confirmation_request_box').removeClass('hidden').velocity("transition.slideLeftIn");
	});
