...
export var PerCapitaInvestmentCard = Class.extend({
  init: function(divClass, city_id, current_year) {
    ...
    this.popUrl = window.populateData.endpoint + '/datasets/ds-inversion-por-habitante.json?sort_desc_by=date&with_metadata=true&limit=5&filter_by_municipality_id=' + city_id + '&date_date_range=20100101-' + this.currentYear + '1231';
  },
  getData: function() {
