var LineChartSubcategories = Class.extend({
  ...
  render: function(callback) {
    ...
    d3.json(this.url, function(error, data) {
      ...
      budget.append("path")
        .attr("class", "line-subcategory")
        .attr("d", function(d) { return line(d.values); })
        .attr("stroke", function(d) { return this.color(d.name) }.bind(this));
      ...
      budget.selectAll("circle")
        ...
        .style("fill", function(d) {console.log(d); return this.color(d.name) }.bind(this))
        .attr("r",4)
