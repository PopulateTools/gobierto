...
export default class {
  constructor(options) {
    ...
    const _defaults = {
      ...
      cssClass: null,
      toolTip: I18n.t("gobierto_admin.custom_fields_plugins.table.select_deselect_all"),
      width: 30,
    ...
    function init(grid){
      ...
      const deleteRowsButton = $(`<button class="small ${_options.deleteRowsButtonClass}">${I18n.t("gobierto_admin.custom_fields_plugins.table.remove_rows")}</button>`);
