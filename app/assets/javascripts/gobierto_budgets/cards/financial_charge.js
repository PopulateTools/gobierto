...
var FinancialChargeCard = Class.extend({
  init: function(divClass, city_id) {
    ...
    this.popUrl = window.populateData.endpoint + '/datasets/ds-carga-financiera.json?sort_desc_by=date&with_metadata=true&limit=5&filter_by_municipality_id=' + city_id;
  },
  getData: function() {
