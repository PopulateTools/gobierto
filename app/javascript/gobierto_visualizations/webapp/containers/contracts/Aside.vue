<template>
  <div class="pure-u-1 pure-u-lg-1-4 visualizations-home-aside--gap">
    <SearchFilter
      :data="contractsData"
      :search-type="type"
    />
...
export default {
  ...
  methods: {
    ...
    updateCounters(firstUpdate=false) {
      ...
      this.contractsData.forEach(({ process_type, contract_type, start_date_year, category_title, contractor }) => {
