...
class Subscribers::GobiertoPeopleActivityTest < ActiveSupport::TestCase
  ...
  def test_event_updated_for_gobierto_people_event
  ...
  def test_event_visibility_level_changed_for_gobierto_people_event
    activity_subject = gobierto_people_person_events(:richard_published)
  ...
  def test_event_state_changed_for_gobierto_people_event
    activity_subject = gobierto_people_person_events(:richard_published)
