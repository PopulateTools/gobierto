          ...
          with_signed_in_admin(admin) do
            with_current_site(site) do
              ...
              within('#edit_question_1', visible: false) do
                ...
                find('#poll_questions_attributes_1_answer_type_single_choice', visible: false).click
              end

              # delete second question first answer template

              within('#question_1_preview_answer_0', visible: false) do
                find('a[data-behavior=delete_answer]', visible: false).click
              end
              ...
              within '#edit_question_3' do
                ...
                find('#poll_questions_attributes_3_answer_type_open', visible: false).click
