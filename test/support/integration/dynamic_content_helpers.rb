                ...
                content_block.fields.each do |content_block_field|
                  within ".content-block-field-#{content_block_field.name.parameterize}" do
                    if content_block_field.currency?
                      fill_in content_block_field.label[I18n.locale], with: "420000.00"
                    else
    ...
    def assert_content_blocks_have_the_right_values
      content_blocks.each do |content_block|
        within "#content-block-#{content_block.id} .dynamic-content-record-view", match: :first do
          content_block.fields.each do |content_block_field|
            if content_block_field.currency?
              assert has_selector?(".content-block-record-value", text: "420000.00")
            else
      ...
      within "#content-block-#{content_block.id}" do
        ...
        within ".cloned-dynamic-content-record-wrapper" do
          content_block.fields.each do |content_block_field|
            within ".content-block-field-#{content_block_field.name.parameterize}" do
              if content_block_field.currency?
                fill_in content_block_field.label[I18n.locale], with: "430000.00"
              else
          ...
          content_block.fields.each do |content_block_field|
            if content_block_field.currency?
              assert has_selector?(".content-block-record-value", text: "430000.00")
            else
      ...
      within "#content-block-#{content_block.id}" do
        within ".dynamic-content-record-wrapper.content-block-record-#{content_block_record.id}" do
          ...
          content_block.fields.each do |content_block_field|
            within ".content-block-field-#{content_block_field.name.parameterize}" do
              if content_block_field.currency?
                fill_in content_block_field.label[I18n.locale], with: "440000.00"
              else
          ...
          content_block.fields.each do |content_block_field|
            if content_block_field.currency?
              assert has_selector?(".content-block-record-value", text: "440000.00")
            else
      ...
      within "#content-block-#{content_block.id}" do
        within ".dynamic-content-record-wrapper.content-block-record-#{content_block_record.id}" do
          ...
          content_block.fields.each do |content_block_field|
            within ".content-block-field-#{content_block_field.name.parameterize}" do
              if content_block_field.currency?
                fill_in content_block_field.label[I18n.locale], with: "450000.00"
              else
