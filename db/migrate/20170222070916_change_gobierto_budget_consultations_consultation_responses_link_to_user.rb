...
class ChangeGobiertoBudgetConsultationsConsultationResponsesLinkToUser < ActiveRecord::Migration[5.0]
  def up
    ...
    add_index :gbc_consultation_responses, %i[consultation_id document_number_digest], unique: true, name: 'index_gbc_consultation_responses_on_document_number_digest'
  end
