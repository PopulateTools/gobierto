        ...
        with_javascript do
          with_signed_in_admin(admin) do
            with_current_site(site) do
              ...
              page.find("#consultation_response_gender_male", visible: false).click
              select "Center", from: "Districts"
              fill_in "Association", with: "Asociación Vecinos Arganzuela"
              fill_in "Bio", with: "My short bio"

              page.find("#consultation_response_selected_options_#{item1.id}_5", visible: false).click
              page.find("#consultation_response_selected_options_#{item2.id}_5", visible: false).click
              click_button "Create"

              assert has_alert?("Consultation couldn't be saved. Please, review the responses and try again")

              page.find("#consultation_response_selected_options_#{item1.id}_0", visible: false).click
              page.find("#consultation_response_selected_options_#{item2.id}_-5", visible: false).click
              select "Center", from: "Districts"
              fill_in "Association", with: "Asociación Vecinos Arganzuela"
              fill_in "Bio", with: "My short bio"
