        ...
        with_javascript do
          with_signed_in_admin(admin) do
            with_current_site(site) do
              ...
              find("#gobierto_budgets_options_elaboration_enabled", visible: false).click
              find("#gobierto_budgets_options_budget_lines_feedback_enabled", visible: false).click
              ...
              find("#gobierto_budgets_options_comparison_tool_enabled", visible: false).click
              find("#gobierto_budgets_options_comparison_context_table_enabled", visible: false).click
              find("#gobierto_budgets_options_comparison_tool_enabled", visible: false).click
              find("#gobierto_budgets_options_indicators_enabled", visible: false).click
